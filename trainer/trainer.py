...
def train(args):
    ...
    for session in range(args.nb_session):
        ...
        if session == 0:
            ...
            if args.incremental_mode == 'AFSFFD':
            ...
            if args.incremental_mode == 'norm':
                ...
                teacher_backbone = copy.deepcopy(backbone)
                teacher_classifier = copy.deepcopy(classifier)
                backbone, classifier = ours_new(args, teacher_backbone, teacher_classifier, backbone, classifier, train_loader, test_loader, backbone_optimizer, classifier_optimizer, backbone_scheduler, classifier_scheduler)
